...
; Related .......: Please see: _AD_AddUserToGroup
; Link ..........:
; Example .......:
; ===============================================================================================================================
...
; Return values .: Success - Value (string or 1D zero-based array) of the given attribute
;                  Failure - "", sets @error to:
;                  |1 - $sObject does not exist
...
;                  +$sValue can be a single value (as a string) or a multi-value (as a one-dimensional zero based array)
...
; Related .......: Please see: _AD_RemoveUserFromGroup
; Link ..........:
; Example .......:
; ===============================================================================================================================
...
; Description ...: Returns an array with information about the AD.au3 UDF.
...
Func _AD_VersionInfo()
	Local $aOL_VersionInfo[9] = [8, "V", 1, 5, 3.0, "20210414", "3.3.12.0", "Jonathan Clelland, water", _
